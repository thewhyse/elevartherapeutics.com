 ...
 */
class ConallEdgeClassSocialIconWidget extends ConallEdgeClassWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            conall_edge_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__( 'Text Size (px)', 'conall' ),
                    'name' => 'text_size'
                ),
                array(
                    'type' => 'textfield',
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__( 'Hover Color', 'conall' ),
                    'name' => 'hover_color'
                ),
                array(
                    'type' => 'textfield',
                    'title' => esc_html__( 'Margin', 'conall' ),
                    'name' => 'margin',
                    'description' => esc_html__( 'Margin (top right bottom left)', 'conall' )
                )
            )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if (!empty($instance['text_size']) && $instance['text_size'] !== '') {
            $social_icon_styles[] = 'font-size: '.conall_edge_filter_px($instance['text_size']).'px';
        }
