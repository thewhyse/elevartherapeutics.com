	...
	<div class="edgtf-post-content">
		...
		<div class="edgtf-post-text">
			...
			<?php if(esc_html(get_post_meta(get_the_ID(), "edgtf_post_link_link_meta", true)) !== '') { ?>
				<a class="edgtf-link-text" href="<?php echo esc_url(get_post_meta(get_the_ID(), "edgtf_post_link_link_meta", true)); ?>"><?php echo esc_html(get_post_meta(get_the_ID(), "edgtf_post_link_link_meta", true)); ?></a>
			<?php } ?>
