            ...
            <div class="edgtf-portfolio-single-nav-inner">
                <?php if(get_previous_post() !== '') : ?>
                    <div class="edgtf-portfolio-prev">
                        <?php if($nav_same_category) {
                            previous_post_link('%link', '<span class="icon-arrows-slim-left"></span>', true, '', 'portfolio-category');
                        } else {
                ...
                <?php if(get_next_post() !== '') : ?>
                    <div class="edgtf-portfolio-next">
                        <?php if($nav_same_category) {
                            next_post_link('%link', '<span class="icon-arrows-slim-right"></span>', true, '', 'portfolio-category');
                        } else {
