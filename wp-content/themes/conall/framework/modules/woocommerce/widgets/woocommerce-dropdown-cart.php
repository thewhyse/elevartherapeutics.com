						...
						<ul>
							<?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
								...
								<li>
									...
									<div class="edgtf-item-info-holder">
										...
										<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__('Remove this item', 'conall') ), $cart_item_key ); ?>
									</div>
								</li>
							<?php endforeach; ?>
							<div class="edgtf-cart-bottom">
								...
								<div class="edgtf-btns-holder clearfix">
									<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="edgtf-ddcw-button edgtf-view-cart"><?php esc_html_e( 'VIEW CART', 'conall' ); ?></a>
									<a href="<?php echo esc_url(wc_get_checkout_url()); ?>" class="edgtf-ddcw-button edgtf-checkout"><?php esc_html_e( 'CHECKOUT', 'conall' ); ?></a>
								</div>
							</div>
						</ul>
					</div>
