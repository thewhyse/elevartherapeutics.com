    ...
    function conall_edge_woocommerce_assets() {
        ...
        if(conall_edge_is_woocommerce_installed()) {
            if(conall_edge_load_woo_assets()) {
                ...
                wp_enqueue_style('conall-edge-woo', EDGE_ASSETS_ROOT.'/css/woocommerce.min.css');

                //is responsive option turned on?
                if(conall_edge_options()->getOptionValue('responsiveness') == 'yes') {
                    //include theme's woocommerce responsive styles
                    wp_enqueue_style('conall-edge-woo-responsive', EDGE_ASSETS_ROOT.'/css/woocommerce-responsive.min.css');
                }
            }
        }
    }
...
if(!function_exists('conall_edge_is_product_tag')) {
	function conall_edge_is_product_tag() {
