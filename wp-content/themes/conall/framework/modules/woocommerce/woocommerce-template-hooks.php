...
if (!function_exists('conall_edge_woocommerce_image_size_gallery_thumbnail')) {
	/**
	 * Function for overriding Single Product Thumbnail Image Size
	 */
	function conall_edge_woocommerce_image_size_gallery_thumbnail( $size ) {
		return array(
			'width'  => 600,
			'height' => 600,
			'crop'   => 1,
	...
	add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'conall_edge_woocommerce_image_size_gallery_thumbnail' );
}
