...
if ( ! function_exists('conall_edge_load_search_template') ) {
	...
	function conall_edge_load_search_template() {
		...
		if ( conall_edge_options()->getOptionValue('search_icon_pack') !== '' ) {
			$search_icon = conall_edge_icon_collections()->getSearchIcon( conall_edge_options()->getOptionValue('search_icon_pack'), true );
			$search_icon_close = conall_edge_icon_collections()->getSearchClose( conall_edge_options()->getOptionValue('search_icon_pack'), true );
		}
