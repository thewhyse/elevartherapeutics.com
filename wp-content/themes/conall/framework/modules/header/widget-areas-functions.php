    ...
    function conall_edge_register_top_header_areas() {
        ...
        if($top_bar_enabled == 'yes') {
            register_sidebar(array(
                ...
                'description'   => esc_html__( 'Widgets added here will appear on the left side in top header area', 'conall' ),
            ...
            if($top_bar_layout === 'three-columns') {
                register_sidebar(array(
                    ...
                    'description'   => esc_html__( 'Widgets added here will appear on the middle side in top header area', 'conall' ),
            ...
            register_sidebar(array(
                ...
                'description'   => esc_html__( 'Widgets added here will appear on the right side in top header area', 'conall' ),
