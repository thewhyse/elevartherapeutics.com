...
use ConallEdgeNamespace\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'ConallEdgeNamespace\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
                case 'header-standard':
                    ...
                    break;
                case 'header-simple':
                    $this->headerObject = new Types\HeaderSimple();
                    break;
                case 'header-classic':
                    $this->headerObject = new Types\HeaderClassic();
                    break;    
                case 'header-divided':
