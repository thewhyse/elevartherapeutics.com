...
if(!function_exists('conall_edge_custom_breadcrumbs')) {
    ...
    function conall_edge_custom_breadcrumbs() {
        ...
        if (is_home() && !is_front_page()) {
            $output = '<div class="edgtf-breadcrumbs"><div class="edgtf-breadcrumbs-inner"><a '.conall_edge_get_inline_style($bread_style).' href="' . esc_url($homeLink) . '">' . $home . '</a>' . $delimiter . ' <a '.conall_edge_get_inline_style($bread_style).' href="' . esc_url($homeLink) . '">'. get_the_title($pageid) .'</a></div></div>';
        ...
        elseif(is_front_page()) {
            if ($showOnHome == 1) $output = '<div class="edgtf-breadcrumbs"><div class="edgtf-breadcrumbs-inner"><a '.conall_edge_get_inline_style($bread_style).' href="' . esc_url($homeLink) . '">' . $home . '</a></div></div>';
        }

        else {

            $output .= '<div class="edgtf-breadcrumbs"><div class="edgtf-breadcrumbs-inner"><a '.conall_edge_get_inline_style($bread_style).' href="' . esc_url($homeLink) . '">' . $home . '</a>' . $delimiter;
