...
if ( !function_exists('conall_edge_register_full_screen_menu_sidebars') ) {
	...
	function conall_edge_register_full_screen_menu_sidebars() {
		...
		register_sidebar(array(
			'name' => esc_html__( 'Fullscreen Menu Top', 'conall' ),
			'id' => 'fullscreen_menu_above',
			'description' => esc_html__( 'This widget area is rendered above fullscreen menu', 'conall' ),
		...
		register_sidebar(array(
			'name' => esc_html__( 'Fullscreen Menu Bottom', 'conall' ),
			'id' => 'fullscreen_menu_below',
			'description' => esc_html__( 'This widget area is rendered below fullscreen menu', 'conall' ),
