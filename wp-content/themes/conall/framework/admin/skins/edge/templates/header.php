<div class="edgtf-page-header page-header clearfix">
    ...
    <div class="edgtf-theme-name pull-left" >
        <img src="<?php echo esc_url(conall_edge_get_skin_uri() . '/assets/img/logo.png'); ?>" alt="<?php esc_attr_e('edgt_logo','conall')?>" class="edgtf-header-logo pull-left"/>
    ...
    <div class="edgtf-top-section-holder">
        <div class="edgtf-top-section-holder-inner">
            ...
            <div class="edgtf-input-change"><i class="fa fa-exclamation-circle"></i><?php esc_html_e( 'You should save your changes', 'conall' ); ?></div>
            <div class="edgtf-changes-saved"><i class="fa fa-check-circle"></i><?php esc_html_e( 'All your changes are successfully saved', 'conall' ); ?></div>
        </div>
    </div>
