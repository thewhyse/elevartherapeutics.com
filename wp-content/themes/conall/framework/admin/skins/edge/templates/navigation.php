<div class="edgtf-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
        ...
        <li <?php if($is_import_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page=conall_edge_theme_menu_tabimport'); ?>"><i
                    class="fa fa-download edgtf-tooltip edgtf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e( 'Import', 'conall' ); ?>"></i><span><?php esc_html_e( 'Import', 'conall' ); ?></span></a></li>
		<?php } ?>
    </ul>
