        ...
        l.prototype = {
            ...
            createLi: function() {
                ...
                return m.each(function(b) {
                    ...
                    if (g++, !f.hasClass("bs-title-option")) {
                        ...
                        if (f.data("divider") === !0) d.push(h("", b, "divider"));
                        else
                        if (f.data("hidden") === !0) k = f.data("prevHiddenIndex"),
                        f.next().data("prevHiddenIndex", void 0 !== k ? k : b),
            ...
            setSize: function() {
                if (this.findLis(), this.liHeight(), this.options.header && this.$menu.css("padding-top", 0), this.options.size !== !1) {
                    ...
                    if (this.options.size && "auto" != this.options.size && this.$lis.not(x).length > this.options.size) {
            ...
            changeAll: function(b) {
                if (this.multiple) {
                    ...
                    if (0 === d.filter(".selected").length) return;
