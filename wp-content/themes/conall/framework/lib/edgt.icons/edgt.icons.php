...
include EDGE_FRAMEWORK_ROOT_DIR."/lib/edgt.icons/edgt.peicon7stroke.php";

/*
  Class: ConallEdgeClassIconCollections
...
class ConallEdgeClassIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new ConallEdgeClassIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new ConallEdgeClassIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('linea_icons', new ConallEdgeClassLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new ConallEdgeClassSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('pe_icon_7_stroke', new ConallEdgeClassPeIcons('Pe-icon-7-stroke', 'pe_icon_7_stroke'));
    }
    ...
    public function getIconCollectionIcons(iConallEdgeInterfaceIconCollection $collection) {
    ...
    public function enqueueStyles() {
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $collection_key => $collection_obj) {
                wp_enqueue_style('conall-'.$collection_key, $collection_obj->styleUrl);
            }
        }
    }
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
                ...
                echo conall_edge_get_module_part( $iconsObject->getSearchIcon() );
            }
        }
    }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
	            ...
	            echo conall_edge_get_module_part( $iconsObject->getSearchClose() );
            }
        }
    }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            echo conall_edge_get_module_part($iconsObject->getSearchIconValue());
        }
    }
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            echo conall_edge_get_module_part($iconsObject->getMenuSideIcon());
        }
    }
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            echo conall_edge_get_module_part($iconsObject->getBackToTopIcon());
        }
    }
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
                ...
                echo conall_edge_get_module_part($iconsObject->getMobileMenuIcon());
            }
        }
    }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
                ...
                echo conall_edge_get_module_part($iconsObject->getQuoteIcon());
            }
        }
    }
