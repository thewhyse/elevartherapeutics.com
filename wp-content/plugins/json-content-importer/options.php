...
?>
        ...
        <br>
			<?php 
				#$jci_oauth_bearer_access_key = '"autofocus onfocus=alert(/XSS/)//';
				$jci_oauth_bearer_access_key = get_option('jci_oauth_bearer_access_key'); 
			?>
           <input type="text" name="jci_oauth_bearer_access_key" value="<?php echo htmlentities($jci_oauth_bearer_access_key); ?>" size="60"/>
			<hr>
...
<br>
       ...
       <tr>
        ...
        <tr>
			...
			<ul>
				<li><a href="https://www.youtube.com/watch?v=IiMfE_CUPBo" target="_blank">Video: <?php _e('How to - First Shortcode with JSON Content Importer', 'json-content-importer') ?></a> </li>
				<li><a href="https://www.youtube.com/watch?v=GJGBPvaKZsk" target="_blank">Video: <?php _e('How to: Wikipedia API, JSON Content Importer and WordPress', 'json-content-importer') ?></a></li>
...
<a href="https://json-content-importer.com/?sc=wp" target="_blank"><img src="<?php echo plugins_url( 'images/icon-256x256.png', __FILE__ ); ?>" border="0" title="<?php _e('Learn more about JSON Content Importer PRO', 'json-content-importer') ?>"></a>
       ...
       <?php _e('Try it without risk: Full refund, if the PRO plugin can\'t solve your challenge', 'json-content-importer') ?>
        ...
        <li><?php _e('and much more...', 'json-content-importer') ?></li>
				...
				<p>
				PRO-Examples: <a href="https://doc.json-content-importer.com/json-content-importer/jci-and-openstreetmaps/" target="_blank">Openstreetmaps</a>, 
				<a href="https://doc.json-content-importer.com/json-content-importer/multisite-search/" target="_blank">Search: Faceted / Multisite</a>...
