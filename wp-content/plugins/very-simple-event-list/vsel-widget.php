...
class vsel_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<select class="widefat" id="<?php echo $this->get_field_id( 'vsel_shortcode' ); ?>" name="<?php echo $this->get_field_name( 'vsel_shortcode' ); ?>">
			<option value='upcoming'<?php echo (esc_attr($vsel_shortcode) == 'upcoming')?' selected':''; ?>><?php esc_attr_e( 'Upcoming events', 'very-simple-event-list' ); ?></option>
			<option value='future'<?php echo (esc_attr($vsel_shortcode) == 'future')?' selected':''; ?>><?php esc_attr_e( 'Future events', 'very-simple-event-list' ); ?></option>
			...
			<option value='past'<?php echo (esc_attr($vsel_shortcode) == 'past')?' selected':''; ?>><?php esc_attr_e( 'Past events', 'very-simple-event-list' ); ?></option>
		...
		<p><label for="<?php echo $this->get_field_id( 'vsel_all_events_link' ); ?>"><?php esc_attr_e('All events link', 'very-simple-event-list'); ?>:</label>
