...
if ($more_info_link_target == 'yes') {
	$more_info_link_target = 'target="_blank" rel="noreferrer noopener"';
} else {
	$more_info_link_target = 'target="_self" rel="noreferrer"';
}
...
if ( wp_date('m', esc_attr($end_date_timestamp), $utc_timezone) > wp_date('m', esc_attr($start_date_timestamp), $utc_timezone) ) {

    $elevar_date_end = '<span class="elevar-event-date end">' . wp_date('F', esc_attr($end_date_timestamp), $utc_timezone) . '&nbsp;' . wp_date('j', esc_attr($end_date_timestamp), $utc_timezone) . '&nbsp;' . wp_date('Y', esc_attr($end_date_timestamp), $utc_timezone) . '</span>';
