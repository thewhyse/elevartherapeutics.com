...
function vsel_field_callback_87() {
	...
	<p><i><?php esc_attr_e( 'This will disable automatic ordering by time.', 'very-simple-event-list' ); ?></i></p>
...
function vsel_field_callback_61() {
	...
	<p><i><?php esc_attr_e( 'This column displays your custom order for events with the same date.', 'very-simple-event-list' ); ?></i></p>
	<p><i><?php esc_attr_e( 'Events are ordered automatically when having start time and end time.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_66() {
	...
	<p><i><?php esc_attr_e( 'This is the width and set as a percentage.', 'very-simple-event-list' ); ?></i></p>
	<p><i><?php esc_attr_e( 'Event details are full width when event info and featured image are hidden.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_95() {
	...
	?>
	<p><i><?php esc_attr_e( 'This tag is being used for the title.', 'very-simple-event-list' ); ?></i></p>
	<p><i><?php esc_attr_e( 'This only affects the shortcode based event list.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_62() {
	...
	?>
	<p><i><?php esc_attr_e( 'Display date label or icon.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_68() {
	...
	<p><strong><i><?php esc_attr_e( 'Date must not be hidden.', 'very-simple-event-list' ); ?></i></strong></p>
	<?php
}
...
function vsel_field_callback_44() {
	...
	<p><i><?php esc_attr_e( 'Events on default WP pages are not ordered by event date.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_99() {
	...
	<?php
	$link_label_rss = __( 'click here', 'very-simple-event-list' );
	$link_rss = '<a href="'.admin_url( 'options-reading.php' ).'">'.$link_label_rss.'</a>';
	$link_label_permalinks = __( 'Permalink', 'very-simple-event-list' );
	$link_permalinks = '<a href="'.admin_url( 'options-permalink.php' ).'">'.$link_label_permalinks.'</a>';
	?>
	<p><i><?php printf( esc_attr__( 'This feed contains upcoming events. For settings %s.', 'very-simple-event-list' ), $link_rss ); ?></i></p>
	<p><strong><i><?php printf( esc_attr__( 'Resave the %s after changing this.', 'very-simple-event-list' ), $link_permalinks ); ?></i></strong></p>
	<?php
	...
	?>
	<p><i><?php printf( __( 'Subscribe with URL %s.', 'very-simple-event-list' ), $feed_link ); ?></i></p>
	<?php
	}
}
...
function vsel_field_callback_49() {
	...
	$link_permalinks = '<a href="'.admin_url( 'options-permalink.php' ).'">'.$link_label_permalinks.'</a>';
	?>
	<p><i><?php esc_attr_e( 'This feed contains upcoming and past events.', 'very-simple-event-list' ); ?></i></p>
	<p><strong><i><?php printf( esc_attr__( 'Resave the %s after changing this.', 'very-simple-event-list' ), $link_permalinks ); ?></i></strong></p>
	<?php
...
<div class="wrap">
	...
	<?php
	$link_label_wp = __( 'click here', 'very-simple-event-list' );
	$link_wp = '<a href="https://wordpress.org/plugins/very-simple-event-list" target="_blank">'.$link_label_wp.'</a>';
	?>
