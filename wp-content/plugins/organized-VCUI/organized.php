...
if ( !defined('WPB_VC_VERSION') ) { add_action('admin_notices', 'mom_org_plug_vc_notice'); return; }
function mom_org_plug_vc_notice() {
...
// add own css
add_action('admin_print_scripts-post.php', 'mom_org_plug_vc_admin_css');
add_action('admin_print_scripts-post-new.php', 'mom_org_plug_vc_admin_css');
if (! function_exists('mom_org_plug_vc_admin_css')) {
function mom_org_plug_vc_admin_css() {
