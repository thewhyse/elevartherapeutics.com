<?php
namespace ConallEdgeNamespace\Modules\Shortcodes\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . conall_edge_get_class_attribute($elements_holder_class) . ' ' . conall_edge_get_inline_attr($elements_holder_style, 'style'). '>';
