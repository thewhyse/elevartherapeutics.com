<?php
namespace ConallEdgeNamespace\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface {
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => conall_edge_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => conall_edge_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = conall_edge_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
