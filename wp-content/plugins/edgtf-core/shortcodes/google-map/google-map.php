<?php
namespace ConallEdgeNamespace\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = conall_edge_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
