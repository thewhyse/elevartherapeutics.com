<?php 
namespace ConallEdgeNamespace\Modules\Shortcodes\GalleryBlocksLeftItem;

use ConallEdgeNamespace\Modules\Shortcodes\ShortcodeInterface;
/**
	* class GalleryBlocksLeftItem
*/
class GalleryBlocksLeftItem implements ShortcodeInterface {
	/**
	 * @var string
	 */
	private $base;
	function __construct() {
		$this->base = 'edgtf_gallery_blocks_left_item';
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( array(
				"name" => esc_html__('Edge Gallery Blocks Left Item', 'edgtf-core'),
				"base" => $this->base,
				"as_child" => array('only' => 'edgtf_gallery_blocks'),
				"category" => 'by EDGE',
				"icon" => "icon-wpb-gallery-blocks-left-item extended-custom-icon",
				"params" => array(
					array(
						'type' => 'dropdown',
						'class' => '',
