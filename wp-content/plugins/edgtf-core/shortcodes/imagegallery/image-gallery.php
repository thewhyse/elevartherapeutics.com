<?php
namespace ConallEdgeNamespace\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface{
		...
		vc_map(array(
			...
			'params'                    => array(
                ...
                array(
                    ...
                    "value" => "",
                    "description" => "Delimit Links by comm",
	...
	public function render($atts, $content = null) {
		...
		$params['slider_classes'] = ($params['navigation'] == 'yes' && $params['pagination'] == 'no') ? 'edgtf-slider-float-navigation' : '';
		...
		$html = conall_edge_get_shortcode_module_template_part('templates/' . $template, 'imagegallery', '', $params);
    ...
    private function getGalleryLinks($params) {
        ...
        if (!empty($params['custom_links'])) {
            $custom_links = explode(',', $params['custom_links']);
        }
