<?php
namespace ConallEdgeNamespace\Modules\Shortcodes\TeamCarousel;

use ConallEdgeNamespace\Modules\Shortcodes\ShortcodeInterface;
/**
 * Class TeamCarousel
 */
class TeamCarousel implements ShortcodeInterface {
	/**
	 * @var string
	 */
	private $base;
	...
	public function vcMap()	{
		...
		vc_map( array(
			...
			'base' => $this->getBase(),
			'as_child' => array('only' => 'edgtf_team_carousels'),
			'category' => 'by EDGE',
			'icon' => 'icon-wpb-team-carousel-item extended-custom-icon',
			'params' => array_merge(
				array(
					array(
						'type' => 'dropdown',
	...
	public function render($atts, $content = null) {
		...
		$html = conall_edge_get_shortcode_module_template_part('templates/team-carousel', 'team-carousels', '', $params);
