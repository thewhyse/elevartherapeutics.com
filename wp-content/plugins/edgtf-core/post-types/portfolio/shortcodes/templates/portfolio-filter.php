	...
	<div class = "edgtf-portfolio-filter-holder-inner">
		...
		<ul>
			<?php if($type == 'masonry' || $type == 'pinterest' || $type == 'masonry-with-space'){ ?>
				<li class="filter" data-filter="*"><span><?php  print esc_html__('Show All', 'edgtf-core')?></span></li>
			<?php } else{ ?>
				<li data-class="filter_<?php print $rand_number ?>" class="filter_<?php print $rand_number ?>" data-filter="all"><span><?php  print esc_html__('Show All', 'edgtf-core')?></span></li>
			<?php } ?>
