...
function edgt_slides_category_taxonomy_custom_fields($tag) {
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slider shortcode', 'edgtf-core'); ?></label>
        </th>
        <td>
            ...
            <span class="description"><?php esc_html_e('Use this shortcode to insert it on page', 'edgtf-core'); ?></span>
        </td>
    </tr>
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Anchor', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Effect on header (dark/light style)', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show prev/next thumbs (except for side menu or passepartout)', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show navigation thumbs', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Insert Passepartout in % ', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show slide number', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Parallax effect', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Auto start', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slides Animation', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Time between slide transitions in milliseconds', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slider height in px', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Responsive height', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show Navigation Arrows', 'edgtf-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show Navigation Bullets', 'edgtf-core'); ?></label>
        </th>
        <td>
...
function edgt_theme_columns($theme_columns) {
    $new_columns = array(
        ...
        'name' => esc_html__('Name', 'edgtf-core'),
        'shortcode' => esc_html__('Shortcode', 'edgtf-core'),
        'slug' => esc_html__('Slug', 'edgtf-core'),
        'posts' => esc_html__('Posts', 'edgtf-core')
    );
    return $new_columns;
}
