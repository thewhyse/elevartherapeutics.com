...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if(isset($slider_meta['header_effect']) && $slider_meta['header_effect'] != '') {
                $slider_header_effect = $slider_meta['header_effect'];
            }
            if (is_array($slider_header_effect) && $slider_header_effect == 'yes') {
            ...
            if (have_posts()) : $postCount = 0;
                ...
                $html .= esc_html__('Sorry, no slides matched your criteria.', 'edgtf-core');
            endif;
            wp_reset_query();
