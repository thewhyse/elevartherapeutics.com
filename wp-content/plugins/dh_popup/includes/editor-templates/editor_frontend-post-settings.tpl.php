			...
			<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements" data-vc-ui-element="panel-content">
				<div class="vc_row">
					<div class="vc_col-sm-12 vc_column" id="vc_settings-title-container">
						<div class="wpb_element_label"><?php _e( 'Popup name', 'js_composer' ) ?></div>
					...
					<div class="vc_col-sm-12 vc_column" id="vc_settings-popup_width-container">
						<div class="wpb_element_label"><?php _e( 'Popup Width', 'js_composer' ) ?></div>
						<div class="edit_form_line">
							<input name="popup_width" class="wpb-textinput" type="text" value="<?php echo esc_attr(dh_popup_get_post_meta('width',$post->ID,'500'))?>"
							       id="dh_popup-width-field"
							       placeholder="<?php _e( 'Deafult 500px', 'js_composer' ) ?>">
						</div>
					</div>
					<div class="vc_col-sm-12 vc_column" id="vc_settings-popup_height-container">
						<div class="wpb_element_label"><?php _e( 'Popup Height', 'js_composer' ) ?></div>
						<div class="edit_form_line">
							<input name="popup_height" class="wpb-textinput" type="text" value="<?php echo esc_attr(dh_popup_get_post_meta('height',$post->ID,''))?>"
							       id="dh_popup-height-field"
							       placeholder="<?php _e( 'Deafult null is auto height', 'js_composer' ) ?>">
						</div>
					</div>
